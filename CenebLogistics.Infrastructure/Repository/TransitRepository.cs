...
{
  public class TransitRepository : GenericRepository<Transit, int>, ITransitRepository
  {

    public TransitRepository(CenebDbContext _dbContext, ILogger _logger) : base(_dbContext, _logger)
    {

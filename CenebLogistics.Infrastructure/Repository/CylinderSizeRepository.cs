...
{
  public class CylinderSizeRepository : GenericRepository<CylinderSize, int>, ICylinderSizeRepository
  {
    public CylinderSizeRepository(CenebDbContext _dbContext, ILogger _logger) : base(_dbContext, _logger)
    {

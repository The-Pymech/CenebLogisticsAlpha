...
{
  public class CylinderVersionRepository : GenericRepository<CylinderVersion, int>, ICylinderVersionRepository
  {

    public CylinderVersionRepository(CenebDbContext _dbContext, ILogger _logger) : base(_dbContext, _logger)
    {

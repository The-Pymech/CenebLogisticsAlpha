using CenebLogistics.Application.Services;
...
namespace CenebLogistics.Infrastructure.Services
{
  internal class EmailService : IEmailService
  {

    public async  Task SendAMailAsync(MailCredential message, EmailArguement credential)
    {
      #region formatter
